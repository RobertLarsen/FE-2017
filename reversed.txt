...
; uint32_t LOC_0xbe = 0
00b0   MOVI  r22, 0xbe
00b4   STORE r0, BYTE [r22+r0]

;Read first 512 program bytes into memory...again
00b8   READ  MEM[r0], DISK[r0] 

;r21 contains 0x14c
;GOTO 0x14c
00bc   ADD   r63, r21, r0

#r61 = r63   Remember where we are (plus four)
014c   ADD   r61, r63, r0
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                                                                  ;;
;r62 = 0x100000, r22 = 6, r20 = 1, r21 = 0x200, r57 = -2                          ;;
0164   MOVI  r62, 0x100000    ; Dunno what this is used for, stack probably       ;;
...
;if (r23 != 0) GOTO 0x198                                                         ;;
0184   MOVI  r57, 0xc                                                             ;;
0188   ADD   r57, r63, r57                                                        ;;
018c   CMOV  r63, r57, r23                                                        ;;
                                                                                  ;;
...
0294   ADD   r59, r63, r57      ; ...more setting return address
0298   MOVI  r57, 0x870         ; Address of putstring
029c   ADD   r63, r57, r0       ; Call putstring


;getstring(0x1200)
02a0   MOVI  r3, 0x1200         ; Address for where to store string
02a4   MOVI  r57, 0x8           ; Set return address
02a8   ADD   r59, r63, r57      ; ...more setting return address
02ac   MOVI  r57, 0x7f8         ; Address of getstring
02b0   ADD   r63, r57, r0       ; Call getstring, length of string is in r1

; If length of string != 0:
;    GOTO 0x2c8
02b4   MOVI  r57, 0xc
02b8   ADD   r57, r63, r57
02bc   CMOV  r63, r57, r1
...
;Length is not 0
;putstring("Initializing decryption")
02c8   ADD   r10, r1, r0      ; Save length of string
02cc   MOVI  r3, 0xadb        ; Point to "Initializing decryption"
02d0   MOVI  r57, 0x8         ; Set return address
02d4   ADD   r59, r63, r57    ; ...more setting return address
02d8   MOVI  r57, 0x870       ; Address of putstring
02dc   ADD   r63, r57, r0     ; Call putstring


;waste_time()
02e0   MOVI  r57, 0x8         ; Set return address
02e4   ADD   r59, r63, r57    ; ...more setting return address
02e8   MOVI  r57, 0x5a4       ; Address of waste_time
02ec   ADD   r63, r57, r0     ; Call waste_time
...
02f8   ADD   r5, r10, r0      ; Third argument to rc4_init, length of password
02fc   MOVI  r57, 0x8         ; Set return address
0300   ADD   r59, r63, r57    ; ...more setting return address
0304   MOVI  r57, 0x5fc       ; Address of rc4_init
0308   ADD   r63, r57, r0     ; Call rc4_init
...
0328   ADD   r59, r63, r57    ; ...more setting return address
032c   MOVI  r57, 0x870       ; Address of putstring
0330   ADD   r63, r57, r0     ; Call putstring

;waste_time()
0334   MOVI  r57, 0x8         ; Set return address
0338   ADD   r59, r63, r57    ; ...more setting return address
033c   MOVI  r57, 0x5a4       ; Address of waste_time
0340   ADD   r63, r57, r0     ; Call waste_time
...
0354   ADD   r59, r63, r57    ; ...more setting return address
0358   MOVI  r57, 0x730       ; Address of rc4_decrypt
035c   ADD   r63, r57, r0     ; Call rc4_decrypt
...
0370   ADD   r59, r63, r57   ; ...more setting return address
0374   MOVI  r57, 0x89c      ; Address of memcmp
0378   ADD   r63, r57, r0    ; Call memcmp

; if regions were different:
;    GOTO 0x500
037c   MOVI  r57, 0x500
0380   ADD   r57, r57, r0
0384   CMOV  r63, r57, r1


0388   MOVI  r3, 0xaf3
038c   MOVI  r57, 0x8
0390   ADD   r59, r63, r57
0394   MOVI  r57, 0x870
0398   ADD   r63, r57, r0
...
0488   MOVI  r57, 0x3d8
048c   ADD   r57, r57, r0
0490   CMOV  r63, r57, r21


; putstring("Bad key!\n")
0500   MOVI  r3, 0xb2b
0504   MOVI  r57, 0x8
0508   ADD   r59, r63, r57
050c   MOVI  r57, 0x870
0510   ADD   r63, r57, r0
...
0520   ADD   r59, r63, r57   ; ...more setting of return address                  ;;
0524   MOVI  r57, 0x870      ; Address of putstring                               ;;
0528   ADD   r63, r57, r0    ; Call putstring                                     ;;
                                                                                  ;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                                                                  ;;
                                                                                  ;;
; r62 -= 4   ; Decrement stack pointer                                            ;;
0568   MOVI  r57, 0x3                                                             ;;
056c   NOR   r57, r57, r57                                                        ;;
0570   ADD   r62, r62, r57                                                        ;;
                                                                                  ;;
; Store return address                                                            ;;
0574   STORE r59, WORD [r62+r0]                                                   ;;
                                                                                  ;;
; busywait(100000)                                                                ;;
0578   MOVI  r3, 1000000          ; How long to busywait                          ;;
057c   MOVI  r57, 0x8             ; Set return address                            ;;
0580   ADD   r59, r63, r57        ; More setting return address                   ;;
0584   MOVI  r57, 0x8f8           ; Address of busywait                           ;;
0588   ADD   r63, r57, r0         ; Call busywait                                 ;;
                                                                                  ;;
;putc('.')                                                                        ;;
058c   MOVI  r57, 0x2e                                                            ;;
0590   OUT   r57                                                                  ;;
...
0594   MOVI  r57, 0x4                                                             ;;
0598   LOAD  r59, WORD [r62+r0]                                                   ;;
059c   ADD   r62, r62, r57                                                        ;;
                                                                                  ;;
;Return                                                                           ;;
05a0   ADD   r63, r59, r0                                                         ;;
                                                                                  ;;
...
05ac   ADD   r62, r62, r57                                                        ;;
                                                                                  ;;
;Store return address                                                             ;;
05b0   STORE r59, WORD [r62+r0]                                                   ;;
                                                                                  ;;
; busywait_and_putc()                                                             ;;
05b4   MOVI  r57, 0x8                ; Set return address                         ;;
05b8   ADD   r59, r63, r57           ; ...more setting return address             ;;
05bc   MOVI  r57, 0x568              ; Address of busywait_and_putc               ;;
05c0   ADD   r63, r57, r0            ; Call busywait_and_putc                     ;;
                                                                                  ;;
; busywait_and_putc()                                                             ;;
05c4   MOVI  r57, 0x8                ; Set return address                         ;;
05c8   ADD   r59, r63, r57           ; ...more setting return address             ;;
05cc   MOVI  r57, 0x568              ; Address of busywait_and_putc               ;;
05d0   ADD   r63, r57, r0            ; Call busywait_and_putc                     ;;
                                                                                  ;;
; busywait_and_putc()                                                             ;;
05d4   MOVI  r57, 0x8                ; Set return address                         ;;
05d8   ADD   r59, r63, r57           ; ...more setting return address             ;;
05dc   MOVI  r57, 0x568              ; Address of busywait_and_putc               ;;
05e0   ADD   r63, r57, r0            ; Call busywait_and_putc                     ;;
                                                                                  ;;
; putc(' ')                                                                       ;;
05e4   MOVI  r57, 0x20                                                            ;;
05e8   OUT   r57                                                                  ;;
...
05ec   MOVI  r57, 0x4                                                             ;;
05f0   LOAD  r59, WORD [r62+r0]                                                   ;;
05f4   ADD   r62, r62, r57                                                        ;;
05f8   ADD   r63, r59, r0                                                         ;;
                                                                                  ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
0698   MOVI  r57, 0x638                                                           ;;
069c   ADD   r57, r57, r0                                                         ;;
06a0   CMOV  r63, r57, r20                                                        ;;
                                                                                  ;;
; key->a = 0                                                                      ;;
; key->b = 0                                                                      ;;
06a4   STORE r0, BYTE [r3+r0]                                                     ;;
06a8   MOVI  r58, 0x1                                                             ;;
06ac   STORE r0, BYTE [r3+r58]                                                    ;;
                                                                                  ;;
; return                                                                          ;;
06b0   ADD   r63, r59, r0                                                         ;;
                                                                                  ;;
...
0738   ADD   r62, r62, r57                                                        ;;
073c   STORE r59, WORD [r62+r0]                                                   ;;
0740   ADD   r20, r0, r0                                                          ;;
0744   MOVI  r57, 0x7cc                                                           ;;
0748   ADD   r63, r57, r0                                                         ;;
                                                                                  ;;
...
0754   ADD   r62, r62, r57                                                        ;;
0758   STORE r3, WORD [r62+r0]                                                    ;;
075c   ADD   r62, r62, r57                                                        ;;
0760   STORE r4, WORD [r62+r0]                                                    ;;
0764   ADD   r62, r62, r57                                                        ;;
0768   STORE r5, WORD [r62+r0]                                                    ;;
076c   ADD   r62, r62, r57                                                        ;;
0770   STORE r20, WORD [r62+r0]                                                   ;;
0774   MOVI  r57, 0x8                                                             ;;
0778   ADD   r59, r63, r57                                                        ;;
077c   MOVI  r57, 0x6b4                                                           ;;
0780   ADD   r63, r57, r0                                                         ;;
                                                                                  ;;
                                                                                  ;;
0784   MOVI  r57, 0x4                                                             ;;
0788   LOAD  r20, WORD [r62+r0]                                                   ;;
078c   ADD   r62, r62, r57                                                        ;;
0790   LOAD  r5, WORD [r62+r0]                                                    ;;
0794   ADD   r62, r62, r57                                                        ;;
0798   LOAD  r4, WORD [r62+r0]                                                    ;;
079c   ADD   r62, r62, r57                                                        ;;
07a0   LOAD  r3, WORD [r62+r0]                                                    ;;
07a4   ADD   r62, r62, r57                                                        ;;
...
07dc   MOVI  r57, 0x74c                                                           ;;
07e0   ADD   r57, r57, r0                                                         ;;
07e4   CMOV  r63, r57, r21                                                        ;;
                                                                                  ;;
                                                                                  ;;
07e8   MOVI  r57, 0x4                                                             ;;
07ec   LOAD  r59, WORD [r62+r0]                                                   ;;
07f0   ADD   r62, r62, r57                                                        ;;
07f4   ADD   r63, r59, r0                                                         ;;
                                                                                  ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;GOTO 0x828                                                                       ;;
0814   MOVI  r57, 0xc                                                             ;;
0818   ADD   r57, r63, r57                                                        ;;
                                                                                  ;;
081c   CMOV  r63, r57, r22                                                        ;;
                                                                                  ;;
;r22 = char - 10                                                                  ;;
;Test if char is '\n'                                                             ;;
0828   MOVI  r57, 0xa                                                             ;;
...
;   GOTO 0x850                                                                    ;;
083c   MOVI  r57, 0xc                                                             ;;
0840   ADD   r57, r63, r57                                                        ;;
0844   CMOV  r63, r57, r22                                                        ;;
                                                                                  ;;
;Char is '\n'                                                                     ;;
;GOTO 0x864                                                                       ;;
0848   MOVI  r57, 0x864                                                           ;;
...
;    GOTO 0x8a8                                                                   ;;
08e4   MOVI  r57, 0x8a8                                                           ;;
08e8   ADD   r57, r57, r0    ; Why? Stupid compiler??                             ;;
08ec   CMOV  r63, r57, r21                                                        ;;
                                                                                  ;;
