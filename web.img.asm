...
0038   MOVI  r57, 0xc                                                             ;;
003c   ADD   r57, r63, r57                                                        ;;
0040   CMOV  r63, r57, r23  ; GOTO 0x4c                                           ;;
                                                                                  ;;
...
0070   ADD   r62, r62, r57
0074   MOVI  r57, 0x1
0078   ADD   r62, r62, r57

; readline(buffer)
007c   ADD   r3, r62, r0    ; First argument is address of buffer
0080   MOVI  r57, 0x8
0084   ADD   r59, r63, r57  ; Setup link register
0088   MOVI  r57, 0x970
008c   ADD   r63, r57, r0   ; Make call to READ_LINE
...
; strchr(buffer, ' ')
0094   ADD   r3, r10, r0    ; First argument is address of buffer
0098   MOVI  r4, 0x20       ; Second argument is ' '
009c   MOVI  r57, 0x8
00a0   ADD   r59, r63, r57  ; Setup link register
00a4   MOVI  r57, 0xba8
00a8   ADD   r63, r57, r0   ; Make call

; if result is not null goto 0xc0
00ac   MOVI  r57, 0xc
00b0   ADD   r57, r63, r57
00b4   CMOV  r63, r57, r1
...
NOT_NULL:
00c0   ADD   r11, r1, r0        ; r11 <- pointer to first space in request
00c4   STORE r0, BYTE [r11+r0]  ; Replace first space with a null byte

; strcpy(0x1485, request_method)
00c8   MOVI  r3, 0x1485         ; Destination for where to copy request method
00cc   ADD   r4, r10, r0        ; Source argument points to request method
00d0   MOVI  r57, 0x8
00d4   ADD   r59, r63, r57      ; Setup link register
00d8   MOVI  r57, 0xb84
00dc   ADD   r63, r57, r0       ; Make call
...
; strchr(buffer, ' ')
00e8   ADD   r3, r10, r0      ; Request path + http version
00ec   MOVI  r4, 0x20         ; Search for a space character
00f0   MOVI  r57, 0x8
00f4   ADD   r59, r63, r57    ; Link register
00f8   MOVI  r57, 0xba8
00fc   ADD   r63, r57, r0     ; Make call

; If a match was found goto 0x114
0100   MOVI  r57, 0xc
0104   ADD   r57, r63, r57
0108   CMOV  r63, r57, r1
...
0114   ADD   r11, r1, r0
0118   STORE r0, BYTE [r11+r0]

; strcpy(0x1495, request_path)
011c   MOVI  r3, 0x1495      ; request_path destination
0120   ADD   r4, r10, r0     ; Source for copy
0124   MOVI  r57, 0x8
0128   ADD   r59, r63, r57   ; Link register
012c   MOVI  r57, 0xb84
0130   ADD   r63, r57, r0    ; Make call
...
0138   MOVI  r4, 0x2f         ; '/'
013c   MOVI  r57, 0x8
0140   ADD   r59, r63, r57    ; Link register
0144   MOVI  r57, 0xacc
0148   ADD   r63, r57, r0     ; Make call
...
0154   ADD   r3, r10, r0      ; http_version
0158   MOVI  r4, 0xd          ; '\r'
015c   MOVI  r57, 0x8
0160   ADD   r59, r63, r57    ; Link register
0164   MOVI  r57, 0xba8
0168   ADD   r63, r57, r0     ; Make call

; If a match was found goto 0x180
016c   MOVI  r57, 0xc
0170   ADD   r57, r63, r57
0174   CMOV  r63, r57, r1
...
0180   ADD   r11, r1, r0
0184   STORE r0, BYTE [r11+r0]

; strcpy(0x1515, http_version)
0188   MOVI  r3, 0x1515      ; http_version
018c   ADD   r4, r10, r0     ; Source for copy
0190   MOVI  r57, 0x8
0194   ADD   r59, r63, r57   ; Link register
0198   MOVI  r57, 0xb84
019c   ADD   r63, r57, r0    ; Make call
...
01a8   MOVI  r57, 0x8
01ac   ADD   r59, r63, r57   ; Link register
01b0   MOVI  r57, 0xb40
01b4   ADD   r63, r57, r0    ; Make call

; If not equal call unsupported_method()
01b8   MOVI  r57, 0x664
01bc   ADD   r57, r57, r0
01c0   CMOV  r63, r57, r1    ; Make call


; If only character of request path was a '/' it is now empty
; If not, goto 0x1e0
01c4   MOVI  r57, 0x1495          ; request_path
01c8   LOAD  r20, BYTE [r57+r0]
01cc   MOVI  r57, 0xc
01d0   ADD   r57, r63, r57
01d4   CMOV  r63, r57, r20
...
01fc   MOVI  r57, 0x4b8
0200   ADD   r57, r57, r0
0204   CMOV  r63, r57, r20

; if (request_path[0] != '/')
;    goto 0x4b8
0208   MOVI  r57, 0x1495
020c   LOAD  r20, BYTE [r57+r0]
0210   MOVI  r57, 0x2f
...
0224   MOVI  r57, 0x4b8
0228   ADD   r57, r57, r0
022c   CMOV  r63, r57, r20

; if (request_path[5] != 'r')
;    goto 0x4b8
0230   MOVI  r57, 0x149a
0234   LOAD  r20, BYTE [r57+r0]
0238   MOVI  r57, 0x72
...
024c   MOVI  r57, 0x4b8
0250   ADD   r57, r57, r0
0254   CMOV  r63, r57, r20

; if (request_path[13] != '.')
;    goto 0x4b8
0258   MOVI  r57, 0x14a2
025c   LOAD  r20, BYTE [r57+r0]
0260   MOVI  r57, 0x2e
...
0274   MOVI  r57, 0x4b8
0278   ADD   r57, r57, r0
027c   CMOV  r63, r57, r20


; if (request_path[2] != 'u')
;    goto 0x4b8
0280   MOVI  r57, 0x1497
0284   LOAD  r20, BYTE [r57+r0]
0288   MOVI  r57, 0x75
...
029c   MOVI  r57, 0x4b8
02a0   ADD   r57, r57, r0
02a4   CMOV  r63, r57, r20


; if (request_path[4] != 'e')
;    goto 0x4b8
02a8   MOVI  r57, 0x1499
02ac   LOAD  r20, BYTE [r57+r0]
02b0   MOVI  r57, 0x65
...
02c4   MOVI  r57, 0x4b8
02c8   ADD   r57, r57, r0
02cc   CMOV  r63, r57, r20


; if (request_path[17] != 'l')
;    goto 0x4b8
02d0   MOVI  r57, 0x14a6
02d4   LOAD  r20, BYTE [r57+r0]
02d8   MOVI  r57, 0x6c
...
02ec   MOVI  r57, 0x4b8
02f0   ADD   r57, r57, r0
02f4   CMOV  r63, r57, r20


; if (request_path[7] != 's')
;    goto 0x4b8
02f8   MOVI  r57, 0x149c
02fc   LOAD  r20, BYTE [r57+r0]
0300   MOVI  r57, 0x73
...
0314   MOVI  r57, 0x4b8
0318   ADD   r57, r57, r0
031c   CMOV  r63, r57, r20


; if (request_path[3] != 'p')
;    goto 0x4b8
0320   MOVI  r57, 0x1498
0324   LOAD  r20, BYTE [r57+r0]
0328   MOVI  r57, 0x70
...
033c   MOVI  r57, 0x4b8
0340   ADD   r57, r57, r0
0344   CMOV  r63, r57, r20


; if (request_path[9] != 'c')
;    goto 0x4b8
0348   MOVI  r57, 0x149e
034c   LOAD  r20, BYTE [r57+r0]
0350   MOVI  r57, 0x63
...
03b4   MOVI  r57, 0x4b8
03b8   ADD   r57, r57, r0
03bc   CMOV  r63, r57, r20


; if (request_path[12] != 't')
;    goto 0x4b8
03c0   MOVI  r57, 0x14a1
03c4   LOAD  r20, BYTE [r57+r0]
03c8   MOVI  r57, 0x74
...
03dc   MOVI  r57, 0x4b8
03e0   ADD   r57, r57, r0
03e4   CMOV  r63, r57, r20



03e8   MOVI  r57, 0x14a5
03ec   LOAD  r20, BYTE [r57+r0]
03f0   MOVI  r57, 0x6d
...
0404   MOVI  r57, 0x4b8
0408   ADD   r57, r57, r0
040c   CMOV  r63, r57, r20


0410   MOVI  r57, 0x149b
0414   LOAD  r20, BYTE [r57+r0]
0418   MOVI  r57, 0x5f
...
042c   MOVI  r57, 0x4b8
0430   ADD   r57, r57, r0
0434   CMOV  r63, r57, r20


0438   MOVI  r57, 0x14a3
043c   LOAD  r20, BYTE [r57+r0]
0440   MOVI  r57, 0x68
...
0454   MOVI  r57, 0x4b8
0458   ADD   r57, r57, r0
045c   CMOV  r63, r57, r20


0460   MOVI  r57, 0x149d
0464   LOAD  r20, BYTE [r57+r0]
0468   MOVI  r57, 0x65
...
047c   MOVI  r57, 0x4b8
0480   ADD   r57, r57, r0
0484   CMOV  r63, r57, r20


0488   MOVI  r57, 0x1496
048c   LOAD  r20, BYTE [r57+r0]
0490   MOVI  r57, 0x73
...
04cc   MOVI  r57, 0xc
04d0   ADD   r57, r63, r57
04d4   CMOV  r63, r57, r20
04d8   MOVI  r57, 0x578
04dc   ADD   r63, r57, r0
...
04e8   MOVI  r57, 0x8
04ec   ADD   r59, r63, r57       ; Link register
04f0   MOVI  r57, 0xb40
04f4   ADD   r63, r57, r0        ; Make call


04f8   MOVI  r57, 0xc
04fc   ADD   r57, r63, r57
0500   CMOV  r63, r57, r1
0504   MOVI  r57, 0x51c
0508   ADD   r63, r57, r0
...
; PUSH link register
0758   ADD   r62, r62, r57
075c   STORE r59, WORD [r62+r0]

; PUSH r10
0760   ADD   r62, r62, r57
0764   STORE r10, WORD [r62+r0]

; PUSH r11
0768   ADD   r62, r62, r57
076c   STORE r11, WORD [r62+r0]

; PUSH r12
0770   ADD   r62, r62, r57
0774   STORE r12, WORD [r62+r0]

; PUSH r13
0778   ADD   r62, r62, r57
077c   STORE r13, WORD [r62+r0]

; Allocate 10 bytes on stack
0780   MOVI  r57, 0x10
0784   NOR   r57, r57, r57
0788   ADD   r62, r62, r57
078c   MOVI  r57, 0x1
0790   ADD   r62, r62, r57
...
087c   OUT   r57
0880   MOVI  r57, 0x10
0884   ADD   r62, r62, r57
0888   MOVI  r57, 0x4
088c   LOAD  r13, WORD [r62+r0]
0890   ADD   r62, r62, r57
0894   LOAD  r12, WORD [r62+r0]
0898   ADD   r62, r62, r57
089c   LOAD  r11, WORD [r62+r0]
08a0   ADD   r62, r62, r57
08a4   LOAD  r10, WORD [r62+r0]
08a8   ADD   r62, r62, r57
08ac   LOAD  r59, WORD [r62+r0]
08b0   ADD   r62, r62, r57
08b4   ADD   r63, r59, r0
                                                                                  ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
08c0   ADD   r62, r62, r57
08c4   STORE r60, WORD [r62+r0]
08c8   ADD   r60, r62, r0
08cc   MOVI  r57, 0xffe00
08d0   NOR   r57, r57, r57
08d4   NOR   r62, r62, r62
08d8   NOR   r62, r57, r62
08dc   MOVI  r57, 0x200
08e0   NOR   r57, r57, r57
08e4   ADD   r62, r62, r57
08e8   MOVI  r57, 0x1
08ec   ADD   r62, r62, r57
08f0   ADD   r20, r0, r0
08f4   MOVI  r57, 0x1ff
...
0950   MOVI  r57, 0x8f4
0954   ADD   r57, r57, r0
0958   CMOV  r63, r57, r21
095c   ADD   r62, r60, r0
0960   MOVI  r57, 0x4
0964   LOAD  r60, WORD [r62+r0]
0968   ADD   r62, r62, r57
096c   ADD   r63, r59, r0
...
098c   MOVI  r57, 0xc                                                             ;;
0990   ADD   r57, r63, r57                                                        ;;
0994   CMOV  r63, r57, r22                                                        ;;
                                                                                  ;;
NOT_NEGATIVE_ONE:                                                                 ;;
...
09b4   MOVI  r57, 0xc                                                             ;;
09b8   ADD   r57, r63, r57                                                        ;;
09bc   CMOV  r63, r57, r22                                                        ;;
                                                                                  ;;
CHAR_IS_NEWLINE:                                                                  ;;
09c0   MOVI  r57, 0x9dc                                                           ;;
09c4   ADD   r63, r57, r0   ; GOTO READ_LINE_END                                  ;;
...
09d4   MOVI  r57, 0x974                                                           ;;
09d8   ADD   r63, r57, r0       ; GOTO READ_NEXT_CHARACTER                        ;;
                                                                                  ;;
READ_LINE_END:                                                                    ;;
;Store null byte at r3+r20                                                        ;;
09dc   STORE r0, BYTE [r3+r20]                                                    ;;
                                                                                  ;;
...
0a6c   ADD   r62, r62, r57
0a70   STORE r22, WORD [r62+r0]
0a74   MOVI  r57, 0x1
0a78   ADD   r20, r20, r57
0a7c   MOVI  r57, 0xa38
0a80   ADD   r57, r57, r0
0a84   CMOV  r63, r57, r4
0a88   ADD   r21, r0, r0
0a8c   MOVI  r57, 0x4
0a90   LOAD  r22, WORD [r62+r0]
0a94   ADD   r62, r62, r57
...
0ab4   MOVI  r57, 0xa8c
0ab8   ADD   r57, r57, r0
0abc   CMOV  r63, r57, r22
0ac0   STORE r0, BYTE [r3+r20]
0ac4   ADD   r1, r20, r0
0ac8   ADD   r63, r59, r0
...
0b20   MOVI  r57, 0xb3c                                                           ;;
0b24   ADD   r57, r57, r0                                                         ;;
0b28   CMOV  r63, r57, r21                                                        ;;
0b2c   STORE r0, BYTE [r3+r20]                                                    ;;
                                                                                  ;;
; while (counter != 0) goto 0xaf8                                                 ;;
0b30   MOVI  r57, 0xaf8                                                           ;;
0b34   ADD   r57, r57, r0                                                         ;;
0b38   CMOV  r63, r57, r20                                                        ;;
                                                                                  ;;
; Return                                                                          ;;
0b3c   ADD   r63, r59, r0                                                         ;;
                                                                                  ;;
...
0bb8   MOVI  r57, 0xc                                                             ;;
0bbc   ADD   r57, r63, r57                                                        ;;
0bc0   CMOV  r63, r57, r21                                                        ;;
                                                                                  ;;
